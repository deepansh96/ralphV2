...
- `delegation_qa_test.sh`: QA checklist parsing across progress edits, canonical digest vectors, plan writes, exact-comment refetch through a fake `gh`, and every `qa-v1` mismatch code.
