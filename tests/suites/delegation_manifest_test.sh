...
child() {
  jq -nc --arg id "$1" --arg task "$2" '{childId:$id,parentId:"parent-1",taskId:$task,run:1,assignmentDigest:null,started:true,completed:true,outcome:"completed",startedAt:1,endedAt:2,effective:{model:null,reasoningEffort:null},nested:false}'
}
...
expected='{"schemaVersion":1,"issue":37,"stepId":"multi-axis-pr-review","attemptId":"attempt-1","provider":"codex","evidenceSource":"app-server","parentId":"parent-1","policy":"pr-review-v1","requested":{"parent":{"model":"gpt-5.6-sol","reasoningEffort":"medium"},"worker":{"model":"gpt-5.6-luna","reasoningEffort":"max"}},"expected":{"taskCount":5,"taskIds":["isolated_codex","matt_spec","matt_standards","ponytail","supe"]},"observed":{"startedCount":5,"completedCount":5,"selectedCount":5},"children":[{"childId":"c-codex","parentId":"parent-1","taskId":"isolated_codex","run":1,"assignmentDigest":null,"started":true,"completed":true,"outcome":"completed","startedAt":1,"endedAt":2,"effective":{"model":null,"reasoningEffort":null},"nested":false,"disposition":"selected"},{"childId":"c-spec","parentId":"parent-1","taskId":"matt_spec","run":1,"assignmentDigest":null,"started":true,"completed":true,"outcome":"completed","startedAt":1,"endedAt":2,"effective":{"model":null,"reasoningEffort":null},"nested":false,"disposition":"selected"},{"childId":"c-standards","parentId":"parent-1","taskId":"matt_standards","run":1,"assignmentDigest":null,"started":true,"completed":true,"outcome":"completed","startedAt":1,"endedAt":2,"effective":{"model":null,"reasoningEffort":null},"nested":false,"disposition":"selected"},{"childId":"c-ponytail","parentId":"parent-1","taskId":"ponytail","run":1,"assignmentDigest":null,"started":true,"completed":true,"outcome":"completed","startedAt":1,"endedAt":2,"effective":{"model":null,"reasoningEffort":null},"nested":false,"disposition":"selected"},{"childId":"c-supe","parentId":"parent-1","taskId":"supe","run":1,"assignmentDigest":null,"started":true,"completed":true,"outcome":"completed","startedAt":1,"endedAt":2,"effective":{"model":null,"reasoningEffort":null},"nested":false,"disposition":"selected"}],"evidenceLevel":"OBSERVED","mismatchCodes":[]}'
...
claude_child='{"childId":"child-1","parentId":"parent-1","taskId":"matt_spec","run":1,"assignmentDigest":null,"started":true,"completed":true,"outcome":"completed","startedAt":1,"endedAt":2,"effective":{"model":"claude-sonnet-4-6","reasoningEffort":"high"},"nested":false}'
...
codex_child='{"childId":"child-1","parentId":"01a07eb4-da4f-70e2-b282-4079106da2e5","taskId":"matt_spec","run":1,"assignmentDigest":null,"started":true,"completed":true,"outcome":"completed","startedAt":1,"endedAt":2,"effective":{"model":"gpt-5.6-luna","reasoningEffort":"max"},"nested":false}'
